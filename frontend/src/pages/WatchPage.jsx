      ...
      <div className=" mx-auto container px-4 py-8 h-full">
        ...
        {trailers.length > 0 && (
          <div className="flex justify-between items-center mb-4">
            <button className={`bg-gray-500/70 hover-gray-500 text-white py-2 px-4 
              rounded ${currentTrailerIdx === 0 ? 'cursor-not-allowed opacity-50' : ''}`}
        ...
        {similarContent.length > 0 && (
          <div className="mt-12 max-w-5xl mx-auto relative">
            ...
            <div className="flex overflow-x-scroll scrollbar-hide gap-4 pb-4 group" ref={sliderRef}>
              ...
              <ChevronLeft className="absolute top-1/2 -translate-y-1/2 left-2 w-8 h-8 opacity-0 group-hover:opacity-100
                transition-all duration-300 cursor-pointer bg-red-600 text-white rounded-full"
                onClick={scrollLeft} />
              <ChevronRight className="absolute top-1/2 -translate-y-1/2 right-2 w-8 h-8 opacity-0 group-hover:opacity-100
                transition-all duration-300 cursor-pointer bg-red-600 text-white rounded-full"
                onClick={scrollRight} />
            </div>
          </div>
